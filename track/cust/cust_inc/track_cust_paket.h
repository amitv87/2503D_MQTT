...
typedef enum
{
    ...
    TR_CUST_POSITION_STATIC_LAST_TIME       = 0x0A,    // 设备静止后上报最后的经纬度，但时间更新
    TR_CUST_POSITION_WIFI_TO_COORDINATES    = 0x0B,    // WIFI解析经纬度上传
    TR_CUST_POSITION_LJDW                   = 0x0C,    // LJDW（立即定位）指令上传
    TR_CUST_POSITION_GPSOFF                 = 0x0D,    // 静态上传    
    TR_CUST_POSITION_GPSDUP                 = 0x0E,    // GPSDUP上传    
