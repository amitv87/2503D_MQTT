...
ELL_track_sensor_afa750_off OTA_track_sensor_afa750_off = 0;
ELL_track_sensor_afa750_on OTA_track_sensor_afa750_on = 0;
ELL_track_sensor_afa750_type_check OTA_track_sensor_afa750_type_check = 0;
...
#if !defined (__REMOVE_OBSOLETE_GSENSOR__)
ELL_track_sensor_mc3410_off OTA_track_sensor_mc3410_off = 0;
ELL_track_sensor_mc3410_on OTA_track_sensor_mc3410_on = 0;
ELL_track_sensor_mc3410_type_check OTA_track_sensor_mc3410_type_check = 0;
ELL_track_sensor_mma8452q_off OTA_track_sensor_mma8452q_off = 0;
ELL_track_sensor_mma8452q_on OTA_track_sensor_mma8452q_on = 0;
ELL_track_sensor_mma8452q_type_check OTA_track_sensor_mma8452q_type_check = 0;
#endif /* __REMOVE_OBSOLETE_GSENSOR__ */
...
extern void track_drv_driving_record_send_msg(kal_uint8 type);
...
int FunAddress[] =
{
	...
	(int)track_drv_driving_record_send_msg,
...
#if !defined (__REMOVE_OBSOLETE_GSENSOR__)
    OTA_track_sensor_afa750_off = (ELL_track_sensor_afa750_off)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_afa750_off %x \n" , OTA_track_sensor_afa750_off ) ;
    OTA_track_sensor_afa750_on = (ELL_track_sensor_afa750_on)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_afa750_on %x \n" , OTA_track_sensor_afa750_on ) ;
    OTA_track_sensor_afa750_type_check = (ELL_track_sensor_afa750_type_check)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_afa750_type_check %x \n" , OTA_track_sensor_afa750_type_check ) ;
#endif /* __REMOVE_OBSOLETE_GSENSOR__ */
...
#if !defined (__REMOVE_OBSOLETE_GSENSOR__)
    OTA_track_sensor_mc3410_off = (ELL_track_sensor_mc3410_off)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_mc3410_off %x \n" , OTA_track_sensor_mc3410_off ) ;
    OTA_track_sensor_mc3410_on = (ELL_track_sensor_mc3410_on)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_mc3410_on %x \n" , OTA_track_sensor_mc3410_on ) ;
    OTA_track_sensor_mc3410_type_check = (ELL_track_sensor_mc3410_type_check)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_mc3410_type_check %x \n" , OTA_track_sensor_mc3410_type_check ) ;
    OTA_track_sensor_mma8452q_off = (ELL_track_sensor_mma8452q_off)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_mma8452q_off %x \n" , OTA_track_sensor_mma8452q_off ) ;
    OTA_track_sensor_mma8452q_on = (ELL_track_sensor_mma8452q_on)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_mma8452q_on %x \n" , OTA_track_sensor_mma8452q_on ) ;
    OTA_track_sensor_mma8452q_type_check = (ELL_track_sensor_mma8452q_type_check)(address[i++]) ;
//    OTA_log ( "OTA_track_sensor_mma8452q_type_check %x \n" , OTA_track_sensor_mma8452q_type_check ) ;
#endif /* __REMOVE_OBSOLETE_GSENSOR__ */
