...
typedef void( *ELL_track_sensor_afa750_off )(void);
extern ELL_track_sensor_afa750_off OTA_track_sensor_afa750_off ;
typedef void( *ELL_track_sensor_afa750_on )(kal_uint8 threshold , FuncPtr callback);
extern ELL_track_sensor_afa750_on OTA_track_sensor_afa750_on;
typedef kal_bool( *ELL_track_sensor_afa750_type_check )(void);
extern ELL_track_sensor_afa750_type_check OTA_track_sensor_afa750_type_check ;
...
#if !defined (__REMOVE_OBSOLETE_GSENSOR__)
typedef void( *ELL_track_sensor_mc3410_off )(void);
extern ELL_track_sensor_mc3410_off OTA_track_sensor_mc3410_off ;
typedef void( *ELL_track_sensor_mc3410_on )(kal_uint8 threshold , FuncPtr callback);
extern ELL_track_sensor_mc3410_on OTA_track_sensor_mc3410_on;
typedef kal_bool( *ELL_track_sensor_mc3410_type_check )(void);
extern ELL_track_sensor_mc3410_type_check OTA_track_sensor_mc3410_type_check ;
typedef void( *ELL_track_sensor_mma8452q_off )(void);
extern ELL_track_sensor_mma8452q_off OTA_track_sensor_mma8452q_off ;
typedef void( *ELL_track_sensor_mma8452q_on )(kal_uint8 threshold , FuncPtr callback);
extern ELL_track_sensor_mma8452q_on OTA_track_sensor_mma8452q_on;
typedef kal_bool( *ELL_track_sensor_mma8452q_type_check )(void);
extern ELL_track_sensor_mma8452q_type_check OTA_track_sensor_mma8452q_type_check ;
#endif /* __REMOVE_OBSOLETE_GSENSOR__ */
