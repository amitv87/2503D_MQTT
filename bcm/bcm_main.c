...
{
    {MSG_ID_BCM_POWER_ONOFF_REQ,cmd_hdlr_bt_power_on_req},
    ...
    {MSG_ID_BCM_WRITE_SCANENABLE_MODE_REQ,cmd_hdlr_bt_write_scan_mode_req},
    ...
    {MSG_ID_BCM_PROFILE_CONN_REQ,cmd_hdlr_bt_profile_conn_req},
#ifdef __BT_OPP_PROFILE__
...
{
    {MSG_ID_BT_READ_RSSI_CNF,bcm_bt_read_rssi_cnf},
...
/* under construction !*/
    ...
    {MSG_ID_BT_RESET_REQ_IND,srv_bt_cm_restart_req_ind_hdler},
    ...
    {MSG_ID_BT_BM_DISCOVERY_CANCEL_CNF,srv_bt_cm_cancel_discovery_cnf_hdler},
    ...
    {MSG_ID_BT_BM_SERVICE_SEARCH_CNF,srv_bt_cm_sdc_search_cnf_hdler},
    ...
    {MSG_ID_BT_BM_PIN_CODE_IND,srv_bt_cm_passkey_ind_hdler},
    ...
    {MSG_ID_BT_BM_LINK_STATE_IND,srv_bt_cm_link_state_ind_hdler},    	
