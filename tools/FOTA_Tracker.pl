...
my $BIN_DIR = "GXQ03D_M2M_11C_PCB01_gprs_MT6261_S00.MAUI_11C_W14_18_IOT_MP_V1_F12.bin";
...
#print $new_bin, "\n";
#print $VER_PARA, "\n";
                system("tools\\crSendDir.exe $new_path $new_bin {R0:0x0,RW:0x80000,NVRAM:0x85000}");
            }
            else
            {
