...
/*MT2502*/  #define  CHIP_ID     CHIP_ID_MT6261
   #endif
   #ifdef  MT2503
/*MT2503*/  #define  CHIP_ID     CHIP_ID_MT6261
   #endif
#endif
...
#define SIM_MT6229 MT6260
   #elif defined(MT6261) || defined(MT2501) || defined(MT2502) || defined(MT2503)
...
/*MT2502RF*/#define  RF_ID    RF_ID_MT6261RF
   #endif   
   #ifdef  MT2503RF_RF
/*MT2503RF*/#define  RF_ID    RF_ID_MT6261RF
   #endif   
   #ifdef  MT6251RF_RF
...
#undef  IS_BAND_COMP_TC_GAIN_SUPPORT
#undef  IS_TEMP_COMP_TC_GAIN_SUPPORT
#undef  IS_KCAL_COMP_TC_GAIN_SUPPORT
#define IS_HEADROOM_DETECTION_SUPPORT              0
#define IS_INBAND_BLOCKER_DETECTION_SUPPORT        0
#define IS_OUTBAND_BLOCKER_DETECTION_SUPPORT       0
#define IS_DYNAMIC_SETPOINT_SUPPORT                0
...
#if IS_COSIM_ON_L1SIM_SUPPORT
#undef IS_CHECK_VCORE_OC_SUPPORT
#define IS_CHECK_VCORE_OC_SUPPORT                  0
...
#define IS_DCS_TX_NOTCH_SWITCH_SUPPORT             1
#else
#define IS_DCS_TX_NOTCH_SWITCH_SUPPORT             0
#endif
