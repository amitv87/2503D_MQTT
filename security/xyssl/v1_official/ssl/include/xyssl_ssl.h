...
#define XYSSL_ERR_TRY_AGAIN_LATER						-0xE800
...
/*Initially this value was defined as 16K....*/
#if defined(__AGPS_SUPPORT__) || defined(__GPS_SSL_SUPPORT__)
#define SSL_MAX_CONTENT_LEN         (16*1024)
#else
#define SSL_MAX_CONTENT_LEN         (15*1024)
#endif

/*Initially this value was defined as 5K....*/
#define SSL_MAX_CONTENT_OUT_LEN         (5*1024)
 ...
 * and encryption overhead (counter + MAC + padding).
 */
#define SSL_BUFFER_OUT_LEN				(SSL_MAX_CONTENT_OUT_LEN + 512)
...
/**
 * Memory Callback Functions Type
 */
typedef void* (*xyssl_adp_malloc_cb)(int mem_size,void* user_data);
typedef void  (*xyssl_adp_free_cb)(void *mem_ptr,void* user_data);
...
struct _ssl_context
{
	...
	*/
	xyssl_adp_malloc_cb alloc;
	xyssl_adp_free_cb free;
	void* user_data;
