...
;  /* Added by Anthony Chin 10/28/2001. */
 CODE32
        ...
        EXPORT INT_InitIntSramDataRegion
        EXPORT INT_InitDSPTXRXRegions
        EXPORT SYS_InitRegions
	EXPORT INT_InitDynamicDCZIMMIpoolRegion
; This macro:
...
;MagicNing Begin
 ; This macro: 通过GFH读取RW节区大小，并复制，不能直接用上面的固定地址
; a) copies RO code and/or RW data from ROM at Load$$area$$Base
; to RAM at Image$$area$$Base, of length Image$$area$$Length bytes.
; b) fills with zero the ZI data in RAM at Image$$area$$ZI$$Base, 
; of length Image$$area$$ZI$$Length bytes.
        ...
        MACRO
        macro_RegionInit_TRACK $areaname
...
track_zi_init	
	...
	SUB     r4, r4, #0x18           
        ...
        MOV     r1, #0x00200000         ; execution address of region
...
;          overwrite r12.
;
;IF :DEF:MT6261 :LOR: :DEF:MT2501 :LOR: :DEF:MT2502
;	MACRO  
;	MT6261_FAMILY
;	MEND
;ENDIF
...
INT_InitEMIInitCode
   ...
   IF :DEF:MT6251 :LOR: :DEF:MT6252 :LOR: :DEF:MT6252H :LOR: :DEF:MT6250 :LOR: :DEF:MT6260 :LOR: :DEF:MT6261 :LOR: :DEF:MT2501 :LOR: :DEF:MT2502
   ; /* NOTE: after MT6260, this region do not contains bootloader sahared information */
...
;/*   None                                                                */
;/*************************************************************************/
; VOID INT_InitIntSramDataRegion(VOID)
; {
;
INT_InitIntSramDataRegion
   ...
   IF :DEF:MT6251 :LOR: :DEF:MT6252 :LOR: :DEF:MT6252H :LOR: :DEF:MT6250
   macro_RegionInit INTSRAM_DATA
   IF :DEF:MT6251
   macro_RegionInit INTSRAM_PROTECTED_RES   
   ENDIF ; MT6251
   ENDIF ; MT6251 || MT6252 || MT6252H || MT6250
...
;/*                                                                       */
;/* DESCRIPTION                                                           */
;/*   Initialize DSP TX/RX regions for NOR projects                       */
;/*                                                                       */
;/* INPUTS                                                                */
;/*   None                                                                */
;/*                                                                       */
...
INT_InitDSPTXRXRegions
   ...
   IF (:DEF:MT6260 :LOR: :DEF:MT6261 :LOR :DEF:MT2501 :LOR: :DEF:MT2502) :LAND: (:LNOT: :DEF: _NAND_FLASH_BOOTING_) :LAND: (:LNOT: :DEF: __NORFLASH_NON_XIP_SUPPORT__)
...
;/*                                                                       */
;/* DESCRIPTION                                                           */
;/*   Initialize Dynamic_Cacheable_Extsram_Default_Cacheable_ZI_MMIPOOL for NOR projects                       */
;/*                                                                       */
;/* INPUTS                                                                */
;/*   None                                                                */
;/*                                                                       */
...
;/*   None                                                                */
;/*************************************************************************/
; VOID INT_InitDynamicDCZIMMIpoolRegion(VOID)
; {
;
INT_InitDynamicDCZIMMIpoolRegion
   MOV   r7,lr
   
   IF :DEF: __DCM_WITH_COMPRESSION_MAUI_INIT__
...
INT_InitRegions
   ...
   ELSE ; _NAND_FLASH_BOOTING_ || _NOR_FLASH_BOOTING_ || __EMMC_BOOTING__
      ...
      ;A new feature from M6260, Rom region will shawdom to Ram when NOR booting to support the serial flash which doesn't support suspend/resume 
         ...
         ;when DCM_WITH_COMPRESSION_MAUI_INIT is enabled, DYNAMIC_COMP_MAUIINIT region is overlay with ZI_MMIPOOL region to save RAM size
         ;ZI_MMIPOOL will be intialized after DYNAMIC_COMP_MAUIINIT region is released
         macro_ZeroInit   DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI_MMIPOOL
         ENDIF ;__DCM_WITH_COMPRESSION_MAUI_INIT__
         ...
         IF :DEF:__GADGET_SUPPORT__
         macro_RegionInit EXTSRAM_GADGET
         ...
         ENDIF ;IF :DEF: MT6260 :LOR: :DEF: MT6261 :LOR: :DEF: MT2501 :LOR: :DEF: MT2502
      ELSE ;__NORFLASH_NON_XIP_SUPPORT__
         IF :DEF:MT6235 :LOR: :DEF: MT6235B :LOR: :DEF: MT6268A :LOR: :DEF: MT6268 :LOR: :DEF: MT6236 :LOR: :DEF: MT6236B :LOR: :DEF: MT6270A :LOR: :DEF: MT6256 :LOR: :DEF: MT6255 :LOR: :DEF: MT6276 :LOR: :DEF: MT6573 :LOR: :DEF: MT6575 :LOR: :DEF: MT6253E :LOR: :DEF: MT6253L :LOR: :DEF: MT6252 :LOR: :DEF: MT6252H :LOR: :DEF:MT6250 :LOR: :DEF:MT6260 :LOR: :DEF:MT6261 :LOR: :DEF:MT2501 :LOR: :DEF:MT2502
            macro_RegionInit PAGE_TABLE
            macro_RegionInit CACHED_EXTSRAM
            macro_RegionInit CACHED_EXTSRAM_PROTECTED_RES
            macro_RegionInit CACHED_EXTSRAM_NVRAM_LTABLE
...
;/***** BEGIN MTK_ELL RAM      ---- add by MagicNing  ******************/
   macro_RegionInit_TRACK TRACK_RAM 
;/***** END MTK_ELL RAM      ---- add by MagicNing  *******************/
         ...
         IF :DEF:MT6229 :LOR: :DEF:MT6230 :LOR: :DEF:MT6223 :LOR: :DEF: MT6223P :LOR: :DEF:MT6238 :LOR: :DEF:MT6235 :LOR: :DEF:MT6268T :LOR: :DEF: MT6235B :LOR: :DEF: MT6239 :LOR: :DEF: TK6516 :LOR: :DEF: MT6268A :LOR: :DEF: MT6253T :LOR: :DEF: MT6516 :LOR: :DEF: MT6268 :LOR: :DEF: MT6253 :LOR: :DEF: MT6253E :LOR: :DEF: MT6253L :LOR: :DEF: MT6252 :LOR: :DEF: MT6252H :LOR: :DEF:MT6250 :LOR: :DEF: MT6236 :LOR: :DEF: MT6236B :LOR: :DEF: MT6268H :LOR: :DEF: MT6270A :LOR: :DEF: MT6256 :LOR: :DEF: MT6255 :LOR: :DEF: MT6276 :LOR: :DEF: MT6573 :LOR: :DEF: MT6575
            macro_RegionInit EXTSRAM_DSP_TX
            macro_RegionInit EXTSRAM_DSP_RX
         ENDIF
         ...
         IF :DEF:MT6251
            macro_RegionInit INTSRAM_DSP_TX_RX
         ENDIF
...
SYS_InitRegions
   ...
   IF :DEF:MT6229 :LOR: :DEF:MT6230 :LOR: :DEF: MT6238 :LOR: :DEF: MT6235 :LOR: :DEF: MT6268T :LOR: :DEF: MT6235B :LOR: :DEF: MT6239 :LOR: :DEF: TK6516 :LOR: :DEF: MT6268A :LOR: :DEF: MT6516 :LOR: :DEF: MT6268 :LOR: :DEF: MT6236 :LOR: :DEF: MT6236B :LOR: :DEF: MT6268H :LOR: :DEF: MT6270A :LOR: :DEF: MT6256 :LOR: :DEF: MT6255 :LOR: :DEF: MT6260 :LOR: :DEF: MT6276 :LOR: :DEF: MT6573 :LOR: :DEF: MT6575
      macro_RegionInit SECONDARY_EXTSRAM_DSP_TX
      macro_RegionInit SECONDARY_EXTSRAM_DSP_RX
   ENDIF 

   IF :DEF: MT6276 :LOR: :DEF: MT6270A :LOR: :DEF: MT6573 :LOR: :DEF: MT6575
   ...
   macro_ZeroInit   DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI_MMIPOOL
   macro_ZeroInit   DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI_VIDEOPOOL
   macro_ZeroInit_InputSection _fs_filetable_zi
