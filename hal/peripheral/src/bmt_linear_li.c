...
static kal_bool bmt_Chr_Is_Charge_Full(BATPHYStruct *pBATPHYS)
{
	...
	{
#if defined ( __BT_DEMO_PROJECT__)||defined (__ET310__) || defined (__MT200__) ||defined (__ET320__)|| defined (__GT370__)|| defined (__GT380__)||defined (__ET350__)||defined (__NT22__)||defined (__JM81__)||defined (__JM66__)
		full_count = 0;
#endif
		return KAL_FALSE;
	}
...
#if defined (__BMT_NO_ISENSE_RESISTOR__) || defined (__ET310__)|| defined (__MT200__) ||defined (__ET320__)|| defined (__GT370__)|| defined (__GT380__)||defined (__ET350__)||defined (__NT22__)||defined (__JM81__)||defined (__JM66__)
	index = 0;
#else
