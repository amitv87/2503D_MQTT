...
/*控制充电中的休眠使能       --    chengjun  2016-07-08*/
void bmt_enable_sleepmode(kal_bool enable)
{
    ...
    {
#if defined (__ET310__)|| defined (__MT200__) ||defined (__ET320__)|| defined (__GT370__)|| defined (__GT380__)||defined (__ET350__)||defined (__NT22__)||defined (__JM81__)||defined (__JM66__)
...
static void get_isense(BATPHYStruct *BATPHYS)
{
    ...
    OTA_LOGD(L_SYS, L_V6, "%d, %d", BMT_VOL_RESULT[BMT_ADC_VISENSE], BMT_VOL_RESULT[BMT_ADC_VBAT]);
...
void bmt_set_chr_current(void)
{
    ...
    switch(chr_type)
    {
        ...
        case PW_USB_CHR:
#if defined (__GT800__)||defined(__NT31__) || defined(__NT22__) 
            chr_current = PMU_CHARGE_CURRENT_300_00_MA;
#else
...
#if defined (__ET310__) || defined (__ET320__) || defined (__MT200__)|| defined (__GT370__)|| defined (__GT380__)||defined (__ET350__)||defined (__NT22__)||defined (__JM81__)||defined (__JM66__)
