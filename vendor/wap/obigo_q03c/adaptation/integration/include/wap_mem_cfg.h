 ...
 */
	...
	#elif (WAP_CUSTOM_CFG_BROWSER_ASM !=0)
		#define WAP_ASM_MEM_SIZE	WAP_CUSTOM_CFG_BROWSER_ASM
    #elif defined(WAP_FLAVOR_LARGE_MEM_POOL) 
#ifdef OBIGO_Q03C_SLIM
        #define WAP_ASM_MEM_SIZE MEM_CHECK_EXTRA_SIZE(1024*400)
#else
...
#ifdef __MMI_WAP_IMAGE_CACHE_ASM__
#ifdef WAP_CUSTOM_CFG_SUPPORT_LARGE_MEM_POOL
#define WAP_MEM_WCACHE_SIZE  (125*1024)
#else
#define WAP_MEM_WCACHE_SIZE  (50*1024)
#endif 
#else /* __MMI_WAP_IMAGE_CACHE_ASM__ */
#define WAP_MEM_WCACHE_SIZE  (0)
#endif /* __MMI_WAP_IMAGE_CACHE_ASM__ */
/***************************************************************************** 
