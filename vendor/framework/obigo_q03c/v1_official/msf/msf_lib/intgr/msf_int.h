...
typedef enum
{
    MSF_WAP_STORAGE_PHONE = 0,        
    MSF_WAP_STORAGE_SYSTEM,        
    MSF_WAP_STORAGE_MEM_CARD_1, 
	MSF_WAP_STORAGE_NONE /*This has to be the last element of this enum*/
} msf_wap_storage_enum;
...
void 
gmms_hdi_file_set_ext_drive(char *src,msf_wap_storage_enum drive);
int
