...
void
gmms_msf_dcvt_init (msf_dcvt_t *obj, short operation,
 ...
 */
int
gmms_msf_dcvt_change_pos (msf_dcvt_t* obj, long steps);

int
gmms_msf_dcvt_uint8 (msf_dcvt_t *obj, MSF_UINT8 *p);

int
gmms_msf_dcvt_int8 (msf_dcvt_t *obj, MSF_INT8 *p);

int
gmms_msf_dcvt_uint16 (msf_dcvt_t *obj, MSF_UINT16 *p);

int
gmms_msf_dcvt_int16 (msf_dcvt_t *obj, MSF_INT16 *p);

int
gmms_msf_dcvt_uint32 (msf_dcvt_t *obj, MSF_UINT32 *p);

int
gmms_msf_dcvt_int32 (msf_dcvt_t *obj, MSF_INT32 *p);

int
gmms_msf_dcvt_bool (msf_dcvt_t *obj, MSF_BOOL *p);

int
gmms_msf_dcvt_uintvar_len (MSF_UINT32 n);

int
gmms_msf_dcvt_uintvar (msf_dcvt_t *obj, MSF_UINT32 *p);

int
gmms_msf_dcvt_static_uchar_vector (msf_dcvt_t *obj, long length, unsigned char *p);

int
gmms_msf_dcvt_uchar_vector (msf_dcvt_t *obj, long length, unsigned char **p);

int
gmms_msf_dcvt_string (msf_dcvt_t *obj, char **p);

#ifdef CFG_MSF_HAS_FLOAT
int
gmms_msf_dcvt_float32 (msf_dcvt_t *obj, MSF_FLOAT32 *p);
#endif

int
gmms_msf_dcvt_array (msf_dcvt_t *obj, int element_size,
                int num_elements, void **array,
                msf_dcvt_element_t *cvt_element);


#define msf_dcvt_init gmms_msf_dcvt_init

#define msf_dcvt_change_pos gmms_msf_dcvt_change_pos

#define msf_dcvt_uint8 gmms_msf_dcvt_uint8

#define msf_dcvt_int8 gmms_msf_dcvt_int8

#define msf_dcvt_uint16 gmms_msf_dcvt_uint16

#define msf_dcvt_int16 gmms_msf_dcvt_int16

#define msf_dcvt_uint32 gmms_msf_dcvt_uint32

#define msf_dcvt_int32 gmms_msf_dcvt_int32

#define msf_dcvt_bool gmms_msf_dcvt_bool

#define msf_dcvt_uintvar_len gmms_msf_dcvt_uintvar_len

#define msf_dcvt_uintvar gmms_msf_dcvt_uintvar

#define msf_dcvt_static_uchar_vector gmms_msf_dcvt_static_uchar_vector

#define msf_dcvt_uchar_vector gmms_msf_dcvt_uchar_vector

#define msf_dcvt_string gmms_msf_dcvt_string

#ifdef CFG_MSF_HAS_FLOAT
#define msf_dcvt_float32 gmms_msf_dcvt_float32
#endif

#define msf_dcvt_array gmms_msf_dcvt_array
