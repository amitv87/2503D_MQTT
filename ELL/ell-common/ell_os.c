...
void ELL_Funtion_Dummy_track_drv_driving_record_send_msg(kal_uint8 type)
{
}

ELL_track_drv_driving_record_send_msg OTA_track_drv_driving_record_send_msg = ELL_Funtion_Dummy_track_drv_driving_record_send_msg ;
