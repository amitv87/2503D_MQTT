...
#include "..//..//..//track//nvram//track_nvram_default_value.h"
#endif /* __GPS_TRACK__ */
...
static nvram_ef_audio_at_speech_info_struct const NVRAM_EF_AUDIO_AT_SPEECH_INFO_DEFAULT[NVRAM_EF_AUDIO_VIBR_TOTAL]
= {
	0,0,0,1,1,1,0
};
#endif
...
ltable_entry_struct logical_data_item_table_audio[] =
{
...
#ifdef __AUDIO_AT_CMD__
	{
		...
		NVRAM_EF_AUDIO_AT_SPEECH_INFO_TOTAL,
		NVRAM_EF_AUDIO_AT_SPEECH_INFO_SIZE,
		NVRAM_NORMAL(NVRAM_EF_AUDIO_AT_SPEECH_INFO_DEFAULT),
		NVRAM_CATEGORY_USER,
		NVRAM_ATTR_AVERAGE,
		"MT83",
		VER(NVRAM_EF_AUDIO_AT_SPEECH_INFO_LID)
	},
#endif
#if defined(__GPS_TRACK__)
    //#include "..//..//..//track//nvram//track_nvram_table.c"
    {
