...
#include "nvram_default_audio.h"
    ...
    #include "..//..//..//track//nvram//track_nvram_struct.c"
#endif   /*__GPS_TRACK__*/
...
/***********************************************************************
  ...
  ***
  ***********************************************************************/
    LID_BIT NVRAM_EF_CUST_ACOUSTIC_DATA_STRUCT_VERNO NVRAM_EF_CUST_ACOUSTIC_DATA_LID
...
LID_BIT NVRAM_EF_AUDIO_BESLOUDNESS_STRUCT_VERNO NVRAM_EF_AUDIO_BESLOUDNESS_LID
     ...
     {
         audio_besloudness_spk_hsf_coeffs:"BESLOUDNESS SPK HPF Coeffs"
         {
         };
         audio_besloudness_spk_bpf_coeffs:"BESLOUDNESS SPK BPF Coeffs"
         {
         };
         audio_besloudness_spk_lpf_coeffs:"BESLOUDNESS SPK LPF Coeffs"
         {
         };
         audio_besloudness_hdp_hsf_coeffs:"BESLOUDNESS HDP HPF Coeffs"
         {
         };
         audio_besloudness_hdp_bpf_coeffs:"BESLOUDNESS HDP BPF Coeffs"
         {
         };
         audio_besloudness_hdp_lpf_coeffs:"BESLOUDNESS HDP LPF Coeffs"
         {
         };
         ...
         audio_besloudness_Att_Time:"BESLOUDNESS attack time"
         {
         };
         audio_besloudness_Rel_Time:"BESLOUDNESS release time"
         {
         };
...
LID_BIT VER_LID(NVRAM_EF_AUDIO_SWFIR_LID)
    ...
    LID_BIT NVRAM_EF_AUDIO_DUAL_MIC_PARAM_STRUCT_VERNO NVRAM_EF_AUDIO_DUAL_MIC_PARAM_LID
...
/***********************************************************************
  ***  This is a nvram data item bit level description for meta tools nvram editor
  ***
  ***  Logical Data Item ID : NVRAM_EF_AUDIO_BES_EQ_FLEXIBLE_LID
  ***
  ***  Module: L1AUDIO
  ***
  ***  Description: Audio BesEQ initial parameter
  ***
  ***  Maintainer: Scholar Chang
  ***
  ***********************************************************************/
#if defined(__BES_EQ_SUPPORT__)
     LID_BIT NVRAM_EF_AUDIO_BES_EQ_FLEXIBLE_STRUCT_VERNO NVRAM_EF_AUDIO_BES_EQ_FLEXIBLE_LID
     nvram_ef_audio_bes_eq_flexible_struct *NVRAM_EF_AUDIO_BES_EQ_FLEXIBLE_TOTAL
     {
         audio_bes_eq_initial_parameter:"BesEQ initial parameter"
         {
         };
    };
#endif
#if defined(__HD_RECORD__)
	LID_BIT NVRAM_EF_AUDIO_HD_RECORD_STRUCT_VERNO NVRAM_EF_AUDIO_HD_RECORD_LID
	nvram_ef_audio_hd_record_struct * NVRAM_EF_AUDIO_HD_RECORD_TOTAL
	{
	};
#endif /* __HD_RECORD__ */
...
/***********************************************************************
  ***  This is a nvram data item bit level description for meta tools nvram editor
  ***
  ***  Logical Data Item ID : NVRAM_EF_AUDIO_VIBR_LID
  ***
  ***  Module: L1AUDIO
  ***
  ***  Description: Audio vibration speaker initial parameter
  ***
  ***  Maintainer: Scholar Chang
  ***
  ***********************************************************************/
#if defined(__VIBRATION_SPEAKER_SUPPORT__)
     LID_BIT NVRAM_EF_AUDIO_VIBR_STRUCT_VERNO NVRAM_EF_AUDIO_VIBR_LID
     nvram_ef_audio_vibr_struct *NVRAM_EF_AUDIO_VIBR_TOTAL
     {
         vibr_cali_done:"vibration calibration status"
         {
         };
         vibr_fc:"vibration speaker initial parameter"
         {
         };
         vibr_sph_filter_coef:"Vibration SPK SPH filter Coeffs"
         {
         };
         vibr_filter_coef:"Vibration SPK filter Coeffs"
         {
         };
    };
#endif
...
/***********************************************************************
  ***  This is a nvram data item bit level description for meta tools nvram editor
  ***
  ***  Logical Data Item ID : NVRAM_EF_AUDIO_VOICE_CHANGER_LID
  ***
  ***  Module: AUDIO
  ***
  ***  Description: Speech voice changer initial parameter
  ***
  ***  Maintainer: Zhixiong Wang
  ***
  ***********************************************************************/
#ifdef __VOICE_CHANGER_SUPPORT__
     LID_BIT NVRAM_EF_AUDIO_VOICE_CHANGER_STRUCT_VERNO NVRAM_EF_AUDIO_VOICE_CHANGER_LID
     nvram_ef_audio_voice_changer_struct *NVRAM_EF_AUDIO_VOICE_CHANGER_TOTAL
     {
         mode:"voice changer mode"
         {
         };
    };
#endif/* __VOICE_CHANGER_SUPPORT__ */
#ifdef __AUDIO_AT_CMD__
     LID_BIT NVRAM_EF_AUDIO_AT_SPEECH_INFO_STRUCT_VERNO NVRAM_EF_AUDIO_AT_SPEECH_INFO_LID
     nvram_ef_audio_at_speech_info_struct *NVRAM_EF_AUDIO_AT_SPEECH_INFO_TOTAL
     {
         state:"pcm state"
         {
         };
		 ...
		 DLNR_state:"Downlink NR state"
         {
         };
		 ULNR_state:"Uplink NR state"
         {
         };
		 lpk:" pcm loopback"
         {
...
#endif/* __AUDIO_AT_CMD__ */
#if defined(__GPS_TRACK__)
    #include "..//..//..//track//nvram//track_nvram_ver.c"
#endif/*__GPS_TRACK__*/
