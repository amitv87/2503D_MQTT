...
#elif defined(__MMI_CALENDAR_EVENT__)
#define  NUM_OF_TDL           25
#define  NUM_OF_CAL			  (25)
#define  NUM_OF_TASK		  (0)
#else
#define  NUM_OF_TDL           0
#define  NUM_OF_CAL			  (0)
#define  NUM_OF_TASK		  (0)
...
#define  NUM_OF_ALM           1     /* just one item */
#else
#define  NUM_OF_ALM           5
#endif
...
#endif /*__MMI_ALM_SLIM_CUSTOMIZE_TONE_FROM_FMGR__*/
...
#define MAX_SYNCML_NONCE_LEN          16
#define MAX_SYNCML_DIGIST_LEN         16
#define MAX_SYNCML_NOTIFICATION_LEN  128
#define MAX_SYNCML_DATABASE_ADDR_LEN  64
#define MAX_SYNCML_PROFILE_NAME       32
#define MAX_SYNCML_PROXY_ADDR         64
...
#define VIDEO_MAX_PROXY_ADDR_LEN            (MED_MAX_PROXY_ADDR_LEN)
#define VIDEO_MAX_PROXY_ADDR_BUF_SIZE       (VIDEO_MAX_PROXY_ADDR_LEN + 1)*ENCODING_LENGTH
...
#define NVRAM_AZAAN_ALARM_TOTAL  NUM_OF_AZAAN
#define NVRAM_AZAAN_ALARM_SIZE      sizeof(mmi_hijri_azaan_nvram_struct)
...
#define MMI_MEDPLY_MAX_PROXY_ADDR_LEN            (MED_MAX_PROXY_ADDR_LEN)
#define MMI_MEDPLY_MAX_PROXY_ADDR_BUF_SIZE       (MMI_MEDPLY_MAX_PROXY_ADDR_LEN + 1)*ENCODING_LENGTH
