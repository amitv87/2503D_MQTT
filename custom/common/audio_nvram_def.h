...
typedef enum
{
    ...
    NVRAM_EF_AUDIO_AT_SPEECH_INFO_LID           = NVRAM_LID_GRP_AUDIO(14), 

/*
 *  Last LID of GPS Group
 */
 #if defined(__GPS_TRACK__)
//    #include "..//..//..//track//nvram//track_nvram_lid.c"


	NVRAM_EF_SYS_ABNORMAL_LID					= NVRAM_LID_GRP_AUDIO(14),
	NVRAM_EF_GPS_POSITION_LID					= NVRAM_LID_GRP_AUDIO(15),	
	NVRAM_EF_GPS_BACKUP_DATA_PARAM_LID			= NVRAM_LID_GRP_AUDIO(17),
	NVRAM_EF_CHECK_OTA_LID					= NVRAM_LID_GRP_AUDIO(19),
...
#define NVRAM_EF_AUDIO_AT_SPEECH_INFO_STRUCT_VERNO              "01"
#define NVRAM_EF_AUDIO_AT_SPEECH_INFO_DEFUALT_VERNO             "0"
#define NVRAM_EF_AUDIO_AT_SPEECH_INFO_LID_VERNO                 NVRAM_EF_AUDIO_AT_SPEECH_INFO_STRUCT_VERNO NVRAM_EF_AUDIO_AT_SPEECH_INFO_DEFUALT_VERNO
#endif
/*
...
#ifdef __AUDIO_AT_CMD__
#define NVRAM_EF_AUDIO_AT_SPEECH_INFO_COUNT 1
#define NVRAM_EF_AUDIO_AT_SPEECH_INFO_SIZE sizeof(nvram_ef_audio_at_speech_info_struct)
#define NVRAM_EF_AUDIO_AT_SPEECH_INFO_TOTAL 1
#endif
#if defined(__GPS_TRACK__)
    #include "..//..//..//track//nvram//track_nvram_define.c"
#endif   /*__GPS_TRACK__*/
...
typedef struct 
{
	...
	kal_bool ULNR_state;	
	kal_bool lpk;
}nvram_ef_audio_at_speech_info_struct;
#endif
