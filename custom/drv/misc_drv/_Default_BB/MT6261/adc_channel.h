...
#if  defined(__GT800__) || defined(__NT31__) || defined (__NT36__)||defined (__NT33__) || defined(__NT22__) || defined(__NT37__)
/*voltage to temperature*/
#define ADC_TEMP_T1  0*1000000   /*0C*/
#define ADC_TEMP_T2  37*1000000  /*25C*/
#define ADC_TEMP_T3  75*1000000  /*50C*/

#define ADC_TEMP_NTCR1 28130.0   /*resistor at 0C*/
#define ADC_TEMP_NTCR2 5217.3   /*resistor at 37C*/
#define ADC_TEMP_NTCR3 1880.0    /*resistor at 75C*/
#define ADC_TEMP_PUR 24000.0      /* 24K orginal registor*/
...
#if defined(__GT800__)||defined(__NT31__) || defined (__NT36__) || defined (__GT310__) || defined(__NT22__) || defined (__NT37__)
#define ADC_ISENSE_FACTOR (1/0.3) //BMT ISENSE RESISTENCE FACTOR 3.33 = 1/0.3 --> resister use 0.3 Ohm
#elif defined(__GT300S__)|| defined(__HVT001__) || defined (__NT33__)
