...
#if 1//defined(__GPS_SUPPORT__) && defined(__GPS_ADAPTOR_SUPPORT__) && defined(__AGPS_SUPPORT__)
...
extern gpsadaptor_agps_manager_context_struct g_gpsadaptor_agps_ctx;
#endif
