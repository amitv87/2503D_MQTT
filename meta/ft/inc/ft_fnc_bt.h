...
#ifndef _FT_FNC_BT_H_
#define _FT_FNC_BT_H_
...
extern void BtRadio_Set_MT6622_META_NSR_Support(kal_uint8 meta_nsr_support);
/* BlueTooth (BT) v.s NVRAM */
#ifdef __BTMTK__
extern kal_bool  ft_gl_bt_update_online;  // default value: enable
#ifdef __GEMINI__
/* under construction !*/
