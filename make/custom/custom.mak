...
ifdef TRACK_SENSOR_SUPPORT
  ifeq ($(strip $(TRACK_SENSOR_SUPPORT)),TRUE)
	...
	#INC_DIR += custom\drv\track_sensor\DA213\Lib
	
	# __REMOVE_OBSOLETE_GSENSOR__ delete 
        #MC3410
	#COM_DEFS   += __MCUBE_MC3410__
	#COMMINCDIRS += custom\drv\track_sensor\MC3410 
	#INC_DIR += custom\drv\track_sensor\MC3410
	#FOLDER_LIST += custom\drv\track_sensor\MC3410
	#SRC_PATH += custom\drv\track_sensor\MC3410	
	#SRC_LIST += custom\drv\track_sensor\MC3410\track_sensor_mc3410.c

    
        #AFA750
	#COM_DEFS   += __MICRO_AFA750__
	#COMMINCDIRS += custom\drv\track_sensor\AFA750
	#INC_DIR += custom\drv\track_sensor\AFA750
	#FOLDER_LIST += custom\drv\track_sensor\AFA750
	#SRC_PATH += custom\drv\track_sensor\AFA750	
	#SRC_LIST += custom\drv\track_sensor\AFA750\track_sensor_afa750.c


        #MMA8452Q
	#COM_DEFS   += __FREESCALE_MMA8452Q__ 
	#COMMINCDIRS += custom\drv\track_sensor\MMA8452Q
	#INC_DIR += custom\drv\track_sensor\MMA8452Q
	#FOLDER_LIST += custom\drv\track_sensor\MMA8452Q
	#SRC_PATH += custom\drv\track_sensor\MMA8452Q	
	#SRC_LIST += custom\drv\track_sensor\MMA8452Q\track_sensor_mma8452q.c
    
  endif
endif


ifdef PROJECT_SUPPORT_TRACK
