...
if (defined($track_project))
{
    system("copy  /Y custom\\codegen\\${custom}_BB\\codegen_GT741.dws custom\\codegen\\${custom}_BB\\codegen.dws > nul");		
	print"\n copy  /Y custom\\codegen\\${custom}_BB\\codegen_GT741.dws custom\\codegen\\${custom}_BB\\codegen.dws > nul";		
}
else
{
