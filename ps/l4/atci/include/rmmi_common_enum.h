...
enum
{
        ...
        RMMI_BT_CHANNELS_END = RMMI_BT_CHANNELS_START + VIRTUAL_PORTS_NUM - 1,
   		...
   		RMMI_USB_CHANNEL,
   		RMMI_AUDIO_TEMP_CHANNEL, //hong_MT6261_DSDA
   	#endif
...
typedef enum
{
    RMMI_EM_POWER_SCAN_RESULT  = 0x01,
    RMMI_EM_CCCH_BLOCK_STATUS  = 0x02,
    RMMI_EM_SACCH_BLOCK_STATUS = 0x04
} rmmi_em_rrm_feature_cmd_enum;
