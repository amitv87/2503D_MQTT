...
//#endif /* __USB_ENABLE__ */
	...
	MSG_ID_L4CUEM_GET_AUDIO_MUTE_STATUS_REQ,
	MSG_ID_L4CUEM_GET_AUDIO_MUTE_STATUS_CNF,
...
/* under construction !*/
   ...
   MSG_ID_L4CAS_SET_USER_PWC_REQ,
   MSG_ID_L4CAS_SET_USER_PWC_CNF,

   MSG_ID_L4CAS_GET_USER_PWC_REQ,
   MSG_ID_L4CAS_GET_USER_PWC_CNF,

   MSG_ID_L4CAS_GET_SUPPORTED_PWC_REQ,
   MSG_ID_L4CAS_GET_SUPPORTED_PWC_CNF,
   #if defined(__PLMN_LIST_WITH_CELL_INFO__)
   MSG_ID_L4CAS_PLMN_LIST_INFO_REQ,
   MSG_ID_L4CAS_PLMN_LIST_INFO_IND,
   #endif
