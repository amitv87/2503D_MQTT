...
#ifdef __PLMN_LIST_WITH_CELL_INFO__
#define MAX_NUM_PLMN_PER_RAT  8
#else
#define MAX_NUM_PLMN_PER_RAT  16
#endif /* __PLMN_LIST_WITH_CELL_INFO__ */

#if (defined(__R6_NETWORK_SHARING__) || defined(__R6_DSAC__)) || defined (UNIT_TEST)
...
#define PWR_CLASS_1         (1)
#define PWR_CLASS_2         (2)
#define PWR_CLASS_3         (3)
#define PWR_CLASS_4         (4)
#define PWR_CLASS_5         (5)
#define PWR_CLASS_INVALID   (0x00)

#define PWR_CLASS_1_MASK    (0x01)
#define PWR_CLASS_2_MASK    (0x02)
#define PWR_CLASS_3_MASK    (0x04)
#define PWR_CLASS_4_MASK    (0x08)
#define PWR_CLASS_5_MASK    (0x10)
...
#define L3_UL_RESERVED_HEADER_SPACE MAX_VAL(RATDM_UL_CTRL_RESERVED_HEADER_SPACE, SND_UL_CTRL_HEADER_LENGTH)  
