...
#define NVRAM_EF_AT_PROFILE_LID_VERNO                       "000"
...
#define NVRAM_EF_LND_ENTRY_LID_VERNO                     	"000"
...
#define NVRAM_EF_RI_CFG_LID_VERNO                       "000"
#endif /* __8_WIRE_UART_SUPPORT__ */

#if defined(__M2M_CSGT_SUPPORT__)
#define NVRAM_EF_M2M_CSGT_LID_VERNO                       "000"
...
#define NVRAM_EF_USR_PWR_CLS_LID_VERNO                  "000"
...
typedef struct
{
    kal_uint8 addr[MAX_CC_ADDR_LEN];
} nvram_ef_ldn_struct;
...
typedef struct
{
    ...
    kal_uint8 linein_volume_gain[MAX_VOL_LEVEL];
	#endif
...
LID_BIT VER_LID(NVRAM_EF_LND_ENTRY_LID)
	nvram_ef_ldn_struct *NVRAM_EF_LND_ENTRY_TOTAL
	{
	};
#endif
...
LID_BIT VER_LID(NVRAM_EF_USR_PWR_CLS_LID) 
	nvram_ef_usr_pwr_cls_struct * NVRAM_EF_USR_PWR_CLS_TOTAL
	{
	};
#if defined(__8_WIRE_UART_SUPPORT__)
LID_BIT VER_LID(NVRAM_EF_RI_CFG_LID)
     nvram_ef_ri_cfg_struct *NVRAM_EF_RI_CFG_TOTAL
     {
     };
#endif /* __8_WIRE_UART_SUPPORT__ */

#if defined(__M2M_CSGT_SUPPORT__)
LID_BIT VER_LID(NVRAM_EF_M2M_CSGT_LID)
    nvram_ef_m2m_csgt_struct *NVRAM_EF_M2M_CSGT_TOTAL
    {
    };
#endif /* __M2M_CSGT_SUPPORT__ */
